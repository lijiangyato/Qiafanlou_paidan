...
public class FirstPageActivity extends BaseActivity implements OnClickListener {
	...
	// 锟斤拷锟斤拷锟斤拷示锟斤拷式 1 位锟斤拷锟斤拷锟斤拷锟斤拷(默锟较凤拷式) 2 锟斤拷锟斤拷 3 锟斤拷锟斤拷
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//LogUtils.e("锟斤拷录锟斤拷锟斤拷息0000", telNum);
		initViews();
	...
	// 双锟斤拷锟剿筹拷
	// // 双锟斤拷锟剿筹拷 锟斤拷一锟轿碉拷锟斤拷锟绞憋拷锟斤拷锟斤拷锟轿�0
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			...
			if (secondTime - firstTime > 2000) {
				Toast.makeText(this, "你确定退出吗？", Toast.LENGTH_SHORT).show();
